...
<div style="display: flex; justify-content: space-around; align-items: center;">
  <div style="text-align: center;">
    <img src="figures/fig1_depth_pipeline.png" alt="Original Image" style="width: 35%; height: auto;">
    <p><strong>Original Image</strong></p>
  </div>
  <div style="text-align: center;">
    <img src="figures/fig1_depth_pipeline1.png" alt="Depth Map" style="width: 35%; height: auto;">
